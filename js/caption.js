...
function caption(img) {
  ...
  return tf.tidy(() => {
    ...
    while (true) {
      ...
      startWord.push(wordPred);
      if (wordPred == "<end>" || startWord.length > maxLen) break;
    }
...
button.addEventListener("click", function () {
  ...
  alert("generating caption");
  capField.innerText = "Generating Caption ... Please Wait"; // this line doesn't work?
